	...
	return (
      ...
      <div></div>
			...
			<div className={styles.buttons}>
				<Link className={styles.button} href="https://www.youtube.com/@BastardosDayZ" passHref>{youtube}</Link>
				<Link className={styles.button} href="https://www.tiktok.com/@bastardos.dayz" passHref>{tiktok}</Link>
			</div>
		</footer>
	);
};
